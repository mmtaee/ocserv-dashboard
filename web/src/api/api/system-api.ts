...
export const SystemApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        ...
        systemPatch: async (
            ...
            request: SystemPatchSystemUpdateData,
         ...
         * @throws {RequiredError}
         */
        systemPermissionsGet: async (options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
         ...
         * @throws {RequiredError}
         */
        systemSetupPost: async (
            request: SystemSetupSystem,
            options: RawAxiosRequestConfig = {}
        ): Promise<RequestArgs> => {
            // verify required parameter 'request' is not null or undefined
...
export const SystemApiFp = function (configuration?: Configuration) {
    ...
    return {
        ...
        async systemGet(
            authorization: string,
            options?: RawAxiosRequestConfig
        ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<SystemGetSystemResponse>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.systemGet(authorization, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath =
                operationServerMap['SystemApi.systemGet']?.[localVarOperationServerIndex]?.url;
        ...
        async systemInitGet(
            options?: RawAxiosRequestConfig
        ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<SystemGetSystemInitResponse>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.systemInitGet(options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath =
                operationServerMap['SystemApi.systemInitGet']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) =>
                createRequestFunction(
                    localVarAxiosArgs,
                    globalAxios,
        ...
        async systemPatch(
            ...
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath =
                operationServerMap['SystemApi.systemPatch']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) =>
                createRequestFunction(
                    localVarAxiosArgs,
                    globalAxios,
         ...
         * @throws {RequiredError}
         */
        async systemPermissionsGet(
            options?: RawAxiosRequestConfig
        ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ModelsUser>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.systemPermissionsGet(options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath =
                operationServerMap['SystemApi.systemPermissionsGet']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) =>
                createRequestFunction(
                    localVarAxiosArgs,
                    globalAxios,
         ...
         * @throws {RequiredError}
         */
        async systemSetupPost(
            request: SystemSetupSystem,
            options?: RawAxiosRequestConfig
        ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<SystemSetupSystemResponse>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.systemSetupPost(request, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath =
                operationServerMap['SystemApi.systemSetupPost']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) =>
                createRequestFunction(
                    localVarAxiosArgs,
                    globalAxios,
...
export const SystemApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
        ...
        systemGet(
            ...
            options?: RawAxiosRequestConfig
        ): AxiosPromise<SystemGetSystemResponse> {
            return localVarFp
        ...
        systemPatch(
            ...
            return localVarFp
                .systemPatch(requestParameters.authorization, requestParameters.request, options)
                .then((request) => request(axios, basePath));
        },
        /**
         * list of available permissions
         ...
         * @throws {RequiredError}
         */
        systemPermissionsGet(options?: RawAxiosRequestConfig): AxiosPromise<ModelsUser> {
            return localVarFp.systemPermissionsGet(options).then((request) => request(axios, basePath));
        },
        /**
         * Setup user and system config
         * @summary Setup user and system config
         ...
         */
        systemSetupPost(
            requestParameters: SystemApiSystemSetupPostRequest,
            options?: RawAxiosRequestConfig
        ): AxiosPromise<SystemSetupSystemResponse> {
            return localVarFp
                .systemSetupPost(requestParameters.request, options)
                .then((request) => request(axios, basePath));
        }
    };
};
...
export class SystemApi extends BaseAPI {
     ...
     * @memberof SystemApi
     */
    public systemPermissionsGet(options?: RawAxiosRequestConfig) {
        return SystemApiFp(this.configuration)
            .systemPermissionsGet(options)
            .then((request) => request(this.axios, this.basePath));
    }
