...
type ActivateUserData = userusecase.ActivateUserData
type SessionLogsData = userusecase.SessionLogsData
type SessionLogsResponse = userusecase.SessionLogsResponse
type StatisticsData = userusecase.StatisticsData
type StatisticsResponse = userusecase.StatisticsResponse
