...
func NewTelegramBotRepository() *TelegramBotRepository {
	return &TelegramBotRepository{db: database.GetConnection()}
}
...
func (r *TelegramBotRepository) Settings(ctx context.Context) (*models.TelegramSettings, error) {
...
func (r *TelegramBotRepository) SetBotUsername(ctx context.Context, username string) error {
...
func (r *TelegramBotRepository) AccountsByChatID(ctx context.Context, chatID int64) ([]models.TelegramAccount, error) {
...
func (r *TelegramBotRepository) AccountByID(ctx context.Context, id uint) (*models.TelegramAccount, error) {
...
func (r *TelegramBotRepository) SetTelegramUsernameForChat(ctx context.Context, chatID int64, telegramUsername string) error {
	if telegramUsername == "" {
		return nil
	}
	return r.db.WithContext(ctx).
...
func (r *TelegramBotRepository) DeleteAccount(ctx context.Context, id uint) error {
	return r.db.WithContext(ctx).
		Where("id = ?", id).
...
func (r *TelegramBotRepository) AllAccounts(ctx context.Context) ([]models.TelegramAccount, error) {
	var accounts []models.TelegramAccount
	err := r.db.WithContext(ctx).Find(&accounts).Error
	return accounts, err
}

func (r *TelegramBotRepository) MarkLowQuotaNotified(ctx context.Context, id uint, at time.Time) error {
	return r.db.WithContext(ctx).
		Model(&models.TelegramAccount{}).
		Where("id = ?", id).
...
func (r *TelegramBotRepository) OcservUserByID(ctx context.Context, id uint) (*models.OcservUser, error) {
...
func (r *TelegramBotRepository) OcservUsersByIDs(ctx context.Context, ids []uint) (map[uint]*models.OcservUser, error) {
	if len(ids) == 0 {
...
func (r *TelegramBotRepository) OcservUserByUsername(ctx context.Context, username string) (*models.OcservUser, error) {
	var user models.OcservUser
...
func (r *TelegramBotRepository) ActivePackages(ctx context.Context) ([]models.TelegramPackage, error) {
...
func (r *TelegramBotRepository) PackageByID(ctx context.Context, id uint) (*models.TelegramPackage, error) {
...
func (r *TelegramBotRepository) PendingByChat(ctx context.Context, chatID int64) (*models.TelegramRequest, error) {
...
func (r *TelegramBotRepository) CreateRequest(ctx context.Context, req *models.TelegramRequest) (*models.TelegramRequest, error) {
...
func (r *TelegramBotRepository) AttachReceipt(ctx context.Context, id uint, path string) error {
	return r.db.WithContext(ctx).
...
func (r *TelegramBotRepository) RequestByID(ctx context.Context, id uint) (*models.TelegramRequest, error) {
	var req models.TelegramRequest
...
func (r *TelegramBotRepository) AdminStats(ctx context.Context) (AdminStats, error) {
	var s AdminStats
