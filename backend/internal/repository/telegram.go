...
func (r *TelegramRepository) LinkAccount(ctx context.Context, account *models.TelegramAccount) error {
	return r.db.WithContext(ctx).
		Where("chat_id = ? AND ocserv_user_id = ?", account.ChatID, account.OcservUserID).
