...
type Repository interface {
	...
	UpsertAccount(ctx context.Context, chatID int64, telegramUsername string, language models.TelegramLanguage, ocservUserID uint) (*models.TelegramAccount, error)
	...
	UpdateLanguageForChat(ctx context.Context, chatID int64, language models.TelegramLanguage) error
	...
	RequestsByStatuses(ctx context.Context, statuses []models.TelegramRequestStatus, limit int) ([]models.TelegramRequest, error)
