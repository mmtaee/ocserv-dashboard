...
// Client provides methods to interact with systemd services
// using systemctl commands.
type Client struct {
	service string
}

// ClientInterface defines available systemd actions
// for a given service.
...
func (s *Client) runCommand(ctx context.Context, args ...string) (string, error) {
...
func (s *Client) Status(ctx context.Context) (string, error) {
	return s.runCommand(
		ctx,
		"show", s.service,
		"-p", "Id",
...
func (s *Client) Restart(ctx context.Context) error {
...
func (s *Client) Enable(ctx context.Context) error {
...
func (s *Client) Disable(ctx context.Context) error {
