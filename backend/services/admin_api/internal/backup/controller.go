...
type Controller struct {
	...
	ocservGroupRepo *groupusecase.Usecase
	backupRepo      *backupusecase.Usecase
}
...
func New(userUsecase *userusecase.Usecase, groupUsecase *groupusecase.Usecase, backupUsecase *backupusecase.Usecase) *Controller {
	return &Controller{
		request:         request.NewCustomRequest(),
		ocservUserRepo:  userUsecase,
		ocservGroupRepo: groupUsecase,
