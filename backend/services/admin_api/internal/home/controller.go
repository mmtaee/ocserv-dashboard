...
type Controller struct {
	...
	telegramRepo   *telegramusecase.Usecase
}

func New(occtlUsecase *occtlusecase.Usecase, userUsecase *userusecase.Usecase, reports *reportusecase.Usecase, telegram *telegramusecase.Usecase) *Controller {
	return &Controller{
		request:        request.NewCustomRequest(),
		occtlRepo:      occtlUsecase,
		ocservUserRepo: userUsecase,
		reportRepo:     reports,
		telegramRepo:   telegram,
	}
}
