...
type Controller struct {
	...
	ocservOcctlRepo *occtlusecase.Usecase
	reportRepo      *reportusecase.Usecase
}

func New(userUsecase *userusecase.Usecase, occtlUsecase *occtlusecase.Usecase, reports *reportusecase.Usecase) *Controller {
	return &Controller{
		request:         request.NewCustomRequest(),
		ocservUserRepo:  userUsecase,
		ocservOcctlRepo: occtlUsecase,
		reportRepo:      reports,
	}
}
...
func (ctl *Controller) Lock(c *echo.Context) error {
	...
	} else if _, err = ctl.ocservOcctlRepo.Disconnect(u.Username); err != nil {
