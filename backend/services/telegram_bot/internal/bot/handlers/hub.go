...
import (
	...
	"github.com/mmtaee/ocserv-dashboard/backend/services/telegram_bot/internal/auth"
	"github.com/mmtaee/ocserv-dashboard/backend/services/telegram_bot/internal/bot/cbdata"
	"github.com/mmtaee/ocserv-dashboard/backend/services/telegram_bot/internal/i18n"
	"github.com/mmtaee/ocserv-dashboard/backend/services/telegram_bot/internal/repository"
	"github.com/mmtaee/ocserv-dashboard/backend/services/telegram_bot/internal/session"
)
...
func (h *Hub) finalizeNewRequest(ctx context.Context, chatID int64, sess *session.Session, note, lang, tgUsername string) {
	...
	h.notifyAdminNewRequest(ctx, created)
}
...
func (h *Hub) finalizeRenewRequest(ctx context.Context, chatID int64, sess *session.Session, note, lang, tgUsername string) {
	...
	h.notifyAdminRenewRequest(ctx, created)
}
...
func (h *Hub) HandlePhoto(ctx context.Context, m *tgbotapi.Message) {
	...
	h.notifyAdminReceipt(ctx, pending, m)
}
