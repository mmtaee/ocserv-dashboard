...
export const OcservUsersApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        ocservUsersUidActivatePost: async (authorization: string, uid: string, request: OcservUserActivateUserData, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'authorization' is not null or undefined
            ...
            const localVarPath = `/ocserv/users/{uid}/activate`
         ...
         * @throws {RequiredError}
         */
        ocservUsersUidGet: async (uid: string, authorization: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'uid' is not null or undefined
...
export const OcservUsersApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async ocservUsersUidActivatePost(authorization: string, uid: string, request: OcservUserActivateUserData, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
         ...
         * @throws {RequiredError}
         */
        async ocservUsersUidGet(uid: string, authorization: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ModelsOcservUser>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.ocservUsersUidGet(uid, authorization, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['OcservUsersApi.ocservUsersUidGet']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * Ocserv User locking
         ...
         * @throws {RequiredError}
         */
        async ocservUsersUidStatisticsGet(authorization: string, uid: string, dateStart?: string, dateEnd?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<OcservUserStatisticsResponse>> {
...
export const OcservUsersApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        ocservUsersUidGet(requestParameters: OcservUsersApiOcservUsersUidGetRequest, options?: RawAxiosRequestConfig): AxiosPromise<ModelsOcservUser> {
            return localVarFp.ocservUsersUidGet(requestParameters.uid, requestParameters.authorization, options).then((request) => request(axios, basePath));
        },
        /**
         * Ocserv User locking
         * @summary Ocserv User locking
         ...
         * @throws {RequiredError}
         */
        ocservUsersUidStatisticsGet(requestParameters: OcservUsersApiOcservUsersUidStatisticsGetRequest, options?: RawAxiosRequestConfig): AxiosPromise<OcservUserStatisticsResponse> {
...
export class OcservUsersApi extends BaseAPI {
    ...
    public ocservUsersUidGet(requestParameters: OcservUsersApiOcservUsersUidGetRequest, options?: RawAxiosRequestConfig) {
        return OcservUsersApiFp(this.configuration).ocservUsersUidGet(requestParameters.uid, requestParameters.authorization, options).then((request) => request(this.axios, this.basePath));
    }
