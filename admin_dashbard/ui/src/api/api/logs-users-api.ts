...
export const LogsUsersApiFp = function (configuration?: Configuration) {
    ...
    return {
        ...
        async logsUsersGet(
            ...
            sort?: LogsUsersGetSortEnum,
            options?: RawAxiosRequestConfig
        ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<LogUsersLogsResponse>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.logsUsersGet(
                authorization,
                page,
                size,
                order,
            ...
            const localVarOperationServerBasePath =
                operationServerMap['LogsUsersApi.logsUsersGet']?.[localVarOperationServerIndex]?.url;
...
export const LogsUsersApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         */
        logsUsersGet(
            requestParameters: LogsUsersApiLogsUsersGetRequest,
            options?: RawAxiosRequestConfig
        ): AxiosPromise<LogUsersLogsResponse> {
            return localVarFp
                .logsUsersGet(
...
export class LogsUsersApi extends BaseAPI {
    ...
    public logsUsersGet(requestParameters: LogsUsersApiLogsUsersGetRequest, options?: RawAxiosRequestConfig) {
        return LogsUsersApiFp(this.configuration)
            .logsUsersGet(
                requestParameters.authorization,
                requestParameters.page,
                requestParameters.size,
